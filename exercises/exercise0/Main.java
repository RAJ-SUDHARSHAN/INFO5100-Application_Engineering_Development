...
public class Main {
  public static void main(String[] args) {
    ...
    AirConditoner ac1 = new AirConditoner(1, 890, 285, "Samsung", "Split AC", 1.5, true, "White");
    AirConditoner ac2 = new AirConditoner(2, 910, 235, "LG", "Split AC", 3, true, "White");
    AirConditoner ac3 = new AirConditoner(3, 850, 295, "Hitachi", "Window AC", 1, false, "blue");

    System.out.println();

    Book b1 = new Book(1, "Harry Potter", "J.K. Rowling", "Bloomsburry", 800, true, 20, "1997");
    Book b2 = new Book(2, "The Power of Six", "Jobie Hughes, James Frey", "HarperCollins ", 300, true, 20, "2011");
    ...
    Chair ch2 = new Chair(2, 37, 14, "Herman Miller", "Synteic Foam", false, true, true);
    Chair ch3 = new Chair(3, 33, 17, "Ikea", "Synthetic Foam", true, true, true);

    System.out.println();
    
    House h1 = new House(1, 2, 2, 1, false, 28, true, "Town House");
    House h2 = new House(2, 3, 2, 1, true, 28, false, "Apartment");
    ...
    Laptop lap2 = new Laptop(2, "Asus", "Rog Strix", "Grey", "Intel Core i7 Processor", "Windows", 15.6f, 1799);
    ...
    MobilePhone mp2 = new MobilePhone(2, "Google", "Pixel 7 Pro", "Hazel", "Google Tensor G2", "Android", 6.7f, 899);
    ...
    WashingMachine w2 = new WashingMachine(2, 26, 33, "LG", "Top Load", 4, false, 38);
    WashingMachine w3 = new WashingMachine(3, 25, 32, "GE", "Front Load", 10, true, 38);
